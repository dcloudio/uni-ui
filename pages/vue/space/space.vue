<template>
	<view>
		<uni-card :is-shadow="false" is-full>
			<view>使用间距辅助类对元素快速应用 <text class="uni-primary uni-px-3">margin</text> 或 <text
					class="uni-primary uni-px-3">padding</text> 样式， 范围是从 0 到 16。</view>
			<view class="uni-mt-5">规则为 <text class="uni-primary uni-pl-3">uni-${property}${direction}-${size}</text>
			</view>
			...
			<view class="margin">
				<view class="margin-item uni-border-4-bg" :class="[paddingClass,marginClass]">
					<view class="box uni-primary-bg">
						<text class="uni-white">通过下面的选项控制边距</text>
					</view>
				</view>
			</view>
