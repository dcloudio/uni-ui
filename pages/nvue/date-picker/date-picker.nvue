<template>
	<view class="page">
		...
		<view class="example-body">
			<uni-date-picker returnType="timestamp" v-model="single" start="2021-3-20" end="2021-5-20" />
		</view>
		<uni-section :title="'日期时间用法：' + datetimesingle" type="line"></uni-section>
		<view class="example-body">
			<uni-date-picker type="datetime" v-model="datetimesingle" start="2021-3-20 12:00:00"
		...
		<view class="example-body">
			<uni-date-picker v-model="range" type="daterange" start="2021-3-20" end="2021-5-20"
				rangeSeparator="至" />
		</view>
		<uni-section :title="'日期时间范围用法：' + '[' + datetimerange + ']' " type="line"></uni-section>
		<view class="example-body">
			<uni-date-picker v-model="datetimerange" type="datetimerange"
