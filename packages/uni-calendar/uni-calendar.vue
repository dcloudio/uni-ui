<template>
	<view>
		<view v-if="maskShow && !insert" class="uni-calendar__mask" :class="{ 'ani-mask-show': aniMaskShow }"></view>
		<view v-if="maskShow || insert" class="uni-calendar__box" :class="{ 'ani-calendar-show': aniMaskShow, 'uni-calendar__static': insert }">
