  ...
  <view class="uni-pagination">
    <view class="uni-pagination__btns">
      <view class="uni-pagination__btn" :class="currentIndex === 1 ? 'uni-pagination--disabled' : 'uni-pagination--enabled'"
        ...
        @click="clickLeft"> <template v-if="showIcon===true || showIcon === 'true'">
          <uni-icons color="#000" size="20" type="arrowleft" /> </template> <template v-else><text class="uni-pagination-child__btn">{{ prevText }}</text></template>
      </view>
      <view class="uni-pagination__btn" :class="currentIndex === maxPage ? 'uni-pagination--disabled' : 'uni-pagination--enabled'"
        ...
        @click="clickRight"> <template v-if="showIcon===true || showIcon === 'true'">
          <uni-icons color="#000" size="20" type="arrowright" /> </template> <template v-else><text class="uni-pagination-child__btn">{{ nextText }}</text></template>
      </view>
    </view>
    <view class="uni-pagination__num"> <text class="uni-pagination__num-current">{{ currentIndex }}/{{ maxPage || 0 }}</text>
    </view>
  </view>
</template>
<script>
