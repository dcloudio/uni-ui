<template>
  <view>
    ...
    <uni-title title="自定义弹出层" type="line"></uni-title>
    <view class="example-body">
    ...
    <uni-popup ref="popup" :type="type" @change="change"><text class="popup-content">{{ content }}</text></uni-popup>
    ...
    <!-- 插屏弹窗 -->
    <uni-popup ref="image" :type="type" :mask-click="false" :custom="true" @change="change">
