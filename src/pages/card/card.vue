  ...
  <view>
    ...
    <view class="example-body">
      <view v-for="item in list" :key="item.id" class="example-box">
        <uni-card :title="item.title" :is-shadow="item.shadow" :note="item.note" :extra="item.extra" :thumbnail="item.thumbnail"
          @click="clickCard"><text class="content-box-text">{{ item.content }}</text></uni-card>
      </view>
    </view>
    <!-- <view class="example-title">图文卡片</view> -->
    <uni-title title="图文卡片" type="line"></uni-title>
    <view class="example-body">
      <view class="example-box">
        <uni-card :is-shadow="true" title="uni-app 框架" mode="style" thumbnail="https://img-cdn-qiniu.dcloud.net.cn/uniapp/doc/uni0124.png"
          extra="DCloud 2019-05-20 12:32:19" note="true" @click="clickCard">
      ...
      <view class="example-box">
        <uni-card :is-shadow="true" title="DCloud" mode="title" thumbnail="https://img-cdn-qiniu.dcloud.net.cn/new-page/uni.png"
