<template>
	<view class="content">
		...
		<view class="uni-swiper__box">
			...
			<view class="uni-swiper__info">
				<view v-if="mode !== 'nav'" class="uni-swiper__info-item" :class="{'active':styleIndex === index}" v-for="(item,index) in dotStyle"
				 :key="index" @click="selectStyle(index)">
				...
				<view v-if="mode === 'nav'" class="uni-swiper__info-item" :class="{'active':styleIndex === index}" v-for="(item,index) in dotStyle"
				 :key="index" :style="{'background-color':item.selectedBackgroundColor}" @click="selectStyle(index)">
