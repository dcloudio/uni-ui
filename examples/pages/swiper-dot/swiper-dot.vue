  ...
  <view class="content">
    ...
    <view class="example-body">
      <view
        ...
        @click="selectMode('default', 0)">default</view>
      <view
        :class="{ active: modeIndex === 1 }"
        class="example-body-item"
        @click="selectMode('round', 1)">round</view>
      <view
        :class="{ active: modeIndex === 2 }"
        class="example-body-item"
        @click="selectMode('long', 2)">long</view>
      <view
        :class="{ active: modeIndex === 3 }"
        class="example-body-item"
        @click="selectMode('nav', 3)">nav</view>
      <view
        :class="{ active: modeIndex === 4 }"
        class="example-body-item"
        @click="selectMode('indexes', 4)">indexes</view>
    </view>
