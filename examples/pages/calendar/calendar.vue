<template>
	<view class="content">
		...
		<view class="calendar-box"><uni-calendar slide="none" /></view>
		<text class="title">不固定高度</text>
		<view class="calendar-box"><uni-calendar :fixedHeihgt="false" slide="none" /></view>
		<text class="title">日历水平滚动切换</text>
		<view class="calendar-box"><uni-calendar slide="horizontal" /></view>
		<text class="title">日历垂直滚动切换</text>
		<view class="calendar-box"><uni-calendar slide="vertical" /></view>
		<text class="title">禁止选择今天之前的日期</text>
		<view class="calendar-box"><uni-calendar :disable-before="true" slide="none" /></view>
		...
		<view class="calendar-box"><uni-calendar  :lunar="true" slide="none" /></view>
