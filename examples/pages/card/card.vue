          ...
          <template v-slot:footer>
            <view class="footer-box">
              <view
                ...
                @click.stop="footerClick('喜欢')"><uni-icon
                  type="like"
                  color="#666"/><text> 喜欢</text></view>
              <view
                class="footer-box__item"
                @click.stop="footerClick('评论')"><uni-icon
                  type="chat"
                  color="#666"/><text> 评论</text></view>
              <view
                class="footer-box__item"
                @click.stop="footerClick('分享')"><uni-icon
                  type="star"
                  color="#666"/><text> 收藏</text></view>
            </view>
          </template>
        </uni-card>
      </view>
